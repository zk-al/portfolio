    ...
    <section className="work" id="work">
      ...
      <div className="project">
        <div className="project__text-wrap">
          ...
          <p>
            ...
            were tasked with creating a direct delivery website for wholesalers
            to buy our products from across Canada. I was tasked with leading
            this project. I worked with our Senior Designer and Graphic Designer
            to layout the website and from there I led the building and
      ...
      <div className="project">
        <div className="project__text-wrap">
          ...
          <h4>Summary</h4>
          <p>
            Woody Nelson is a Liscencd Producer of Cannabis based in Nelson BC.
            As part of my time as Junior Marketer I was tasked to build a
      ...
      <div className="project">
        <div className="project__text-wrap">
          ...
          <p>
            ...
            creating Reels that encapsulated the brand, and connected with both
            the LoFi music and art audience and the CBD consumers.
          </p>
          <h4>Role</h4>
